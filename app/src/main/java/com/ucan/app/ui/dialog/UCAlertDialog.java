...
public class UCAlertDialog extends Dialog implements View.OnClickListener {
	public static final String TAG = "UCAN.UCAlertDialog";
	/** 左边按钮 */
	...
	public static UCAlertDialog buildAlert(Context ctx, int message,
			int button, OnClickListener listener) {
		return buildAlert(ctx, ctx.getString(message), ctx.getString(button),
				listener);
	}

	public static UCAlertDialog buildAlert(Context ctx, int resId,
	...
	public static UCAlertDialog buildAlert(Context ctx, CharSequence message,
			OnClickListener listener) {
	...
	public static UCAlertDialog buildAlert(Context ctx, CharSequence message,
			...
			OnClickListener negativeClickListener, OnClickListener positive) {
		UCAlertDialog dialog = new UCAlertDialog(ctx);
	...
	public static UCAlertDialog buildPositiveAlert(Context ctx, int resId,
			OnClickListener listener) {
	 ...
	 * @return
	 */
	public static UCAlertDialog buildPositiveAlert(Context ctx,
	 ...
	 * @return
	 */
	public final Button setButton(int id, CharSequence text,
			OnClickListener listener) {
	...
	public final UCAlertDialog setButtonTag(int id, OnClickListener listener) {
		Button button = mButtons.get(id);
