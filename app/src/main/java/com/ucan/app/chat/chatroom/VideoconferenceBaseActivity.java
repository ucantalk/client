package com.ucan.app.chat.chatroom;
...
/**
 */
public abstract class VideoconferenceBaseActivity extends BaseActivity {
	...
	protected void showProcessDialog() {
		...
		mPostingdialog = new UCProgressDialog(VideoconferenceBaseActivity.this,
	...
	protected void showInputCodeDialog(String title, String message,
			final boolean isLandCall) {
		View view = View.inflate(this, R.layout.dialog_edit_context, null);
		final EditText editText = (EditText) view
				.findViewById(R.id.sendrequest_content);
		((TextView) view.findViewById(R.id.sendrequest_tip)).setText(message);
		UCAlertDialog dialog = UCAlertDialog.buildAlert(this, message,
