...
public abstract class AbstractSQLManager {
    ...
    public AbstractSQLManager() {
        openDatabase(UCApplication.getInstance(), AppManager.getVersionCode());
    }
    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        /**数据库名称*/
        static final String DATABASE_NAME = "UCAN_db";
        ...
        public DatabaseHelper(Context context, AbstractSQLManager manager ,int version) {
            this(context, manager , AppManager.getUserId() + "_" + DATABASE_NAME, null, version);
        }
